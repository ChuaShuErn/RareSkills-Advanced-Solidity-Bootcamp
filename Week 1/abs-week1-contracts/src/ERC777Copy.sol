...
contract ERC777Copy is Context, IERC777, IERC20 {
     ...
     */
    constructor(string memory name_, string memory symbol_, address[] memory defaultOperators_, address mockRegistry) {
        _name = name_;
        _symbol = symbol_;
        ...
        _ERC1820_REGISTRY = IERC1820Registry(mockRegistry);
        // register interfaces
