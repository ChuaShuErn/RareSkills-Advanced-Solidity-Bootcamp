...
contract UntrustedEscrow {
    ...
    mapping(address seller => Condition) public conditions;
    ...
    function withdraw() external {
        ...
        //delete the condition mapping
        conditions[msg.sender] =
            Condition({arbitaryToken: IERC20(address(0)), buyer: address(0), amount: 0, creationDate: 0});
